...
/* === Routing Library ===
- Walaupun Go-Lang sudah menyediakan ServeMux sebagai handler yang bisa menghandle beberapa endpoint
...
- Hal ini dikarenakan ServeMux tidak memiliki advanced fitur seperti path variable, auto binding
